##############################################################################
# Taxon-level mediator discovery simulation
# ──────────────────────────────────────────
# Benchmark of taxon-level mediation methods:
#   CAMRA, CRAmed, LDM-med, MarZIC, microHIMA, multimedia
#
# Usage (CHTC):
#   Rscript taxon_level_simulation.R <template> <n> <p> <num1_A> <num1_B>
#                                     <num2> <d> <seed>
##############################################################################
...
num2_in     <- as.numeric(args[6]) # overlap (true mediators): 0, 3, 5, 7, or 9
...
##############################################################################
# SECTION 7: CHTC entry point
##############################################################################

tryCatch({
  result_list <- runone_simulation(
    n = n_in, p = p_in,
